...
class EstabelecimentoSaude(Base):
    ...
    AtividadePrincipal = Column(Integer, ForeignKey("aux_atividade_estabelecimento.id"), nullable=True)
    atividade_estabelecimento = relationship("AtividadeEstabelecimentoSaude", back_populates="estabelecimento_saude")
    AtividadeSecundaria = Column(Integer, ForeignKey("aux_atividade_estabelecimento.id"), nullable=True)
    atividade_secundaria = relationship("AtividadeEstabelecimentoSaude", back_populates="estabelecimento")
