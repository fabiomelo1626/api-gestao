from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Numeric, Date, BigInteger
...
class AutorizacaoInternacaoHospitalar(Base):
    ...
    MotivoSaida = Column(Numeric(1,1), ForeignKey("aux_motivo_saida.id"), nullable=True)
