...
class AutorizacaoInternacaoHospitalar(Base):
    ...
    NumeroAIH = Column(Integer, nullable=True)
    ...
    AIHAnterior = Column(Integer, nullable=True)
    ...
    CNSAutorizador = Column(Integer, nullable=True)
    DiagnosticoPrincipal = Column(String(4), nullable=True)
    CNSPaciente = Column(Integer, nullable=True)
